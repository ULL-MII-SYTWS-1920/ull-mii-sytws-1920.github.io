...
<body>
    <div id="header">
            <nav>
        <li><a href="https://github.com/ULL-MII-SYTWS-1920/ull-mii-sytws-1920.github.io/tree/master//tema2-async/event-loop/exercises/web-workers/node_modules/path-to-regexp/Readme.md" title="Edit this page at GitHub">🐙</a>
        </li>
...
-->    
            ...
            <ul id="sytwstoc">
  <li><a href="#path-to-regexp">Path-to-RegExp</a>
    <ul>
      <li><a href="#usage">Usage</a>
        <ul>
          <li><a href="#pathtoregexppath-keys-options">pathToRegexp(path, keys, options)</a></li>
        </ul>
      </li>
      ...
      <li><a href="#license">License</a></li>
            ...
            <div class="container">
                <h1 id="path-to-regexp">Path-to-RegExp</h1>

<p>Turn an Express-style path string such as <code class="language-plaintext highlighter-rouge">/user/:name</code> into a regular expression.</p>

<p><strong>Note:</strong> This is a legacy branch. You should upgrade to <code class="language-plaintext highlighter-rouge">1.x</code>.</p>

<h2 id="usage">Usage</h2>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><table class="rouge-table"><tbody><tr><td class="rouge-gutter gl"><pre class="lineno">1
</pre></td><td class="rouge-code"><pre><span class="kd">var</span> <span class="nx">pathToRegexp</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">path-to-regexp</span><span class="dl">'</span><span class="p">);</span>
</pre></td></tr></tbody></table></code></pre></div></div>

<h3 id="pathtoregexppath-keys-options">pathToRegexp(path, keys, options)</h3>
...
3
4
</pre></td><td class="rouge-code"><pre><span class="kd">var</span> <span class="nx">keys</span> <span class="o">=</span> <span class="p">[];</span>
<span class="kd">var</span> <span class="nx">exp</span> <span class="o">=</span> <span class="nx">pathToRegexp</span><span class="p">(</span><span class="dl">'</span><span class="s1">/foo/:bar</span><span class="dl">'</span><span class="p">,</span> <span class="nx">keys</span><span class="p">);</span>

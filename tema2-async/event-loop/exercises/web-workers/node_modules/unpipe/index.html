...
<body>
    <div id="header">
            <nav>
        <li><a href="https://github.com/ULL-MII-SYTWS-1920/ull-mii-sytws-1920.github.io/tree/master//tema2-async/event-loop/exercises/web-workers/node_modules/unpipe/README.md" title="Edit this page at GitHub">🐙</a>
        </li>
...
-->    
            ...
            <ul id="sytwstoc">
  <li><a href="#unpipe">unpipe</a>
    <ul>
      <li><a href="#installation">Installation</a></li>
      <li><a href="#api">API</a>
        <ul>
          <li><a href="#unpipestream">unpipe(stream)</a></li>
        </ul>
      </li>
...
</pre></td><td class="rouge-code"><pre><span class="nv">$ </span>npm <span class="nb">install </span>unpipe
</pre></td></tr></tbody></table></code></pre></div></div>

<h2 id="api">API</h2>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><table class="rouge-table"><tbody><tr><td class="rouge-gutter gl"><pre class="lineno">1
</pre></td><td class="rouge-code"><pre><span class="kd">var</span> <span class="nx">unpipe</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">unpipe</span><span class="dl">'</span><span class="p">)</span>
</pre></td></tr></tbody></table></code></pre></div></div>

<h3 id="unpipestream">unpipe(stream)</h3>

<p>Unpipes all destinations from a given stream. With stream 2+, this is
equivalent to <code class="language-plaintext highlighter-rouge">stream.unpipe()</code>. When used with streams 1 style streams
(typically Node.js 0.8 and below), this module attempts to undo the
actions done in <code class="language-plaintext highlighter-rouge">stream.pipe(dest)</code>.</p>

<h2 id="license">License</h2>

<p><a href="/tema2-async/event-loop/exercises/web-workers/node_modules/unpipe/LICENSE">MIT</a></p>

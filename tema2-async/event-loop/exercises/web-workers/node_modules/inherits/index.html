...
<body>
    <div id="header">
            <nav>
        <li><a href="https://github.com/ULL-MII-SYTWS-1920/ull-mii-sytws-1920.github.io/tree/master//tema2-async/event-loop/exercises/web-workers/node_modules/inherits/README.md" title="Edit this page at GitHub">🐙</a>
        </li>
...
-->    
  ...
  <li><a href="#note-on-version-10">note on version ~1.0</a></li>
</ul>
...
2
</pre></td><td class="rouge-code"><pre><span class="kd">var</span> <span class="nx">inherits</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">inherits</span><span class="dl">'</span><span class="p">);</span>

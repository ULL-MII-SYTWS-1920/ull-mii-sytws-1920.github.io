...
<body>
    <div id="header">
            <nav>
        <li><a href="https://github.com/ULL-MII-SYTWS-1920/ull-mii-sytws-1920.github.io/tree/master//tema2-async/event-loop/exercises/web-workers/node_modules/setprototypeof/README.md" title="Edit this page at GitHub">🐙</a>
        </li>
...
-->    
            ...
            <ul id="sytwstoc">
  <li><a href="#polyfill-for-objectsetprototypeof">Polyfill for <code class="language-plaintext highlighter-rouge">Object.setPrototypeOf</code></a>
    <ul>
      <li><a href="#usage">Usage:</a></li>
            ...
            <div class="container">
                <h1 id="polyfill-for-objectsetprototypeof">Polyfill for <code class="language-plaintext highlighter-rouge">Object.setPrototypeOf</code></h1>
...
</pre></td><td class="rouge-code"><pre>$ npm install --save setprototypeof
...
8
9
</pre></td><td class="rouge-code"><pre><span class="kd">var</span> <span class="nx">setPrototypeOf</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">setprototypeof</span><span class="dl">'</span><span class="p">)</span>
...
</pre></td><td class="rouge-code"><pre><span class="k">import</span> <span class="nx">setPrototypeOf</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">setprototypeof</span><span class="dl">'</span><span class="p">)</span>
</pre></td></tr></tbody></table></code></pre></div></div>

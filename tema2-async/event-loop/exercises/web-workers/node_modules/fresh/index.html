...
<body>
    <div id="header">
            <nav>
        <li><a href="https://github.com/ULL-MII-SYTWS-1920/ull-mii-sytws-1920.github.io/tree/master//tema2-async/event-loop/exercises/web-workers/node_modules/fresh/README.md" title="Edit this page at GitHub">🐙</a>
        </li>
...
-->    
            ...
            <ul id="sytwstoc">
  <li><a href="#fresh">fresh</a>
    <ul>
      <li><a href="#installation">Installation</a></li>
      <li><a href="#api">API</a>
        <ul>
          <li><a href="#freshreqheaders-resheaders">fresh(reqHeaders, resHeaders)</a></li>
        </ul>
      </li>
      ...
      <li><a href="#example">Example</a>
        <ul>
          ...
          <li><a href="#using-with-nodejs-http-server">Using with Node.js http server</a></li>
        </ul>
      </li>
...
</pre></td><td class="rouge-code"><pre>$ npm install fresh
...
</pre></td><td class="rouge-code"><pre><span class="kd">var</span> <span class="nx">fresh</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">fresh</span><span class="dl">'</span><span class="p">)</span>
</pre></td></tr></tbody></table></code></pre></div></div>

<h3 id="freshreqheaders-resheaders">fresh(reqHeaders, resHeaders)</h3>

<p>Check freshness of the response using request and response headers.</p>

<p>When the response is still “fresh” in the client’s cache <code class="language-plaintext highlighter-rouge">true</code> is
returned, otherwise <code class="language-plaintext highlighter-rouge">false</code> is returned to indicate that the client
cache is now stale and the full response should be sent.</p>

<p>When a client sends the <code class="language-plaintext highlighter-rouge">Cache-Control: no-cache</code> request header to
indicate an end-to-end reload request, this module will return <code class="language-plaintext highlighter-rouge">false</code>
...
8
9
</pre></td><td class="rouge-code"><pre><span class="kd">var</span> <span class="nx">reqHeaders</span> <span class="o">=</span> <span class="p">{</span> <span class="dl">'</span><span class="s1">if-none-match</span><span class="dl">'</span><span class="p">:</span> <span class="dl">'</span><span class="s1">"foo"</span><span class="dl">'</span> <span class="p">}</span>
<span class="kd">var</span> <span class="nx">resHeaders</span> <span class="o">=</span> <span class="p">{</span> <span class="dl">'</span><span class="s1">etag</span><span class="dl">'</span><span class="p">:</span> <span class="dl">'</span><span class="s1">"bar"</span><span class="dl">'</span> <span class="p">}</span>
...
<span class="kd">var</span> <span class="nx">reqHeaders</span> <span class="o">=</span> <span class="p">{</span> <span class="dl">'</span><span class="s1">if-none-match</span><span class="dl">'</span><span class="p">:</span> <span class="dl">'</span><span class="s1">"foo"</span><span class="dl">'</span> <span class="p">}</span>
<span class="kd">var</span> <span class="nx">resHeaders</span> <span class="o">=</span> <span class="p">{</span> <span class="dl">'</span><span class="s1">etag</span><span class="dl">'</span><span class="p">:</span> <span class="dl">'</span><span class="s1">"foo"</span><span class="dl">'</span> <span class="p">}</span>
<span class="nx">fresh</span><span class="p">(</span><span class="nx">reqHeaders</span><span class="p">,</span> <span class="nx">resHeaders</span><span class="p">)</span>
<span class="c1">// =&gt; true</span>
</pre></td></tr></tbody></table></code></pre></div></div>

<h3 id="using-with-nodejs-http-server">Using with Node.js http server</h3>
...
<span class="kd">function</span> <span class="nx">isFresh</span> <span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
  <span class="k">return</span> <span class="nx">fresh</span><span class="p">(</span><span class="nx">req</span><span class="p">.</span><span class="nx">headers</span><span class="p">,</span> <span class="p">{</span>
    <span class="dl">'</span><span class="s1">etag</span><span class="dl">'</span><span class="p">:</span> <span class="nx">res</span><span class="p">.</span><span class="nx">getHeader</span><span class="p">(</span><span class="dl">'</span><span class="s1">ETag</span><span class="dl">'</span><span class="p">),</span>
    <span class="dl">'</span><span class="s1">last-modified</span><span class="dl">'</span><span class="p">:</span> <span class="nx">res</span><span class="p">.</span><span class="nx">getHeader</span><span class="p">(</span><span class="dl">'</span><span class="s1">Last-Modified</span><span class="dl">'</span><span class="p">)</span>
  <span class="p">})</span>
<span class="p">}</span>
...
<p><a href="/tema2-async/event-loop/exercises/web-workers/node_modules/fresh/LICENSE">MIT</a></p>

...
1. La función `execute` emitirá eventos `begin` y `end` para señalar el comienzo y final de la ejecución de `asyncfun`
...
De manera que cuando se ejecuta, obtenemos una salida como está:

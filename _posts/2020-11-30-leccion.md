...
Para la práctica [p8-t2-async-webpack-esmodule]({{site.bseurl}}/practicas/p8-t2-async-webpack-esmodule.html) recuerden que tienen  que estudiar el tutorial [Getting Started](https://webpack.js.org/guides/getting-started/) y aplicar  lo aprendido en el tutorial a la práctica [anterior p8-t2-async-serialize]({{site.baseurl}}/practicas/p8-t2-async-serialize.html) de manera que 
...
-->
Entregan esta práctica en el mismo repo de la asignación de la práctica [anterior p8-t2-async-serialize]({{site.baseurl}}/practicas/p8-t2-async-serialize.html) en una rama `p8-t2-async-webpack-esmodule`

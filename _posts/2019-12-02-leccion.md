...
Usar [localStorage](https://developer.mozilla.org/en-US/docs/Web/API/Window/localStorage) para guardar el 
JSON ahorrando tiempo de carga

```js
document.lastModified
"12/02/2019 09:05:22"
```
Posiblemente esl servidor de GitHub pages pone la fecha del último `puhsh`

...
[test/parse-rdf-test.js](test/parse-rdf-test.js)
...
[lib/parse-rdf.js](lib/parse-rdf.js)
...
[test/parse-rdf-test.js](databases/test/parse-rdf-test.js)
...
Add the following to your [lib/parse-rdf.js](lib/parse-rdf.js) file, after the line where we set book.id:
...
Using Cheerio, we select the tag named `dcterms:titl` and save its text content to the `book.text` property. 
...
Our [lib/parse-rdf.js](lib/parse-rdf.js)  converts RDF content into JSON documents. 
...
```
​​$ ​​npm​​ ​​install​​ ​​--save​​ ​​--save-exact​​ ​​node-dir
```

...
```
[~/.../p4-t2-networking/networking-with-sockets-chapter-3-crguezl(master)]$ cat lib/
ldj-client.js 
```
...
/*
  Chapter 3. Networking with Sockets.
  Implementing a Message Protocol.
...
```
[~/.../p4-t2-networking/networking-with-sockets-chapter-3-crguezl(master)]$ cat net-watcher-json-client.js 
```
...
Now we run the LDJ client and LDJ server and when saving the file being edited is 
reflected in the messages:

![running client and server](/assets/images/net-ldj-client-server.png)
